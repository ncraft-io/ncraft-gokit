...
import (
	...
	"github.com/ncraft-io/ncraft-go/pkg/sd/direct"
	"github.com/ncraft-io/ncraft-go/pkg/sd/etcdv3"
	"github.com/ncraft-io/ncraft-go/pkg/sd/nacos"
	"strings"
)
...
func New(cfg *Config, logger log.Logger) Client {
	...
	if cfg.EtcdV3 != nil && (mode == EtcdMode || len(mode) == 0) {
		...
		return nacos.NewNacosClient(urls, cfg.Nacos, logger)
	}
	return nil
}
