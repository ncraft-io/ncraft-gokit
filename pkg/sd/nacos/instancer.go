...
import (
	...
	"github.com/ncraft-io/ncraft-go/pkg/sd/internal/instance"
)
...
func NewInstancer(c *NacosClient, serviceName, groupName string, clusters []string, logger log.Logger) (*Instancer, error) {
	s := &Instancer{
		client:      c,
